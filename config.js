...
// Support portable mode - use external data directory if specified (either env var)
const DATA_DIR = (process.env.DATA_DIR || process.env.LOOTYPANEL_DATA_DIR)
  ? path.resolve(process.env.DATA_DIR || process.env.LOOTYPANEL_DATA_DIR)
